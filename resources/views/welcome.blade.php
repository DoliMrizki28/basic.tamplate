...
<head>
    ...
    <title>Sistem Informasi Manajemen Bank Sampah Inayah</title>
...
<body id="page-top">
    <nav class="navbar navbar-expand-lg bg-success navbar-dark fixed-top shadow-sm" id="mainNav">
        <div class="container px-5">
            <a class="navbar-brand fw-bold" href="#page-top">BANK SAMPAH INAYAH</a>
            ...
            <div class="row gx-5 align-items-center">
                <div class="col-lg-6">
                    ...
                    <div class="mb-5 mb-lg-0 text-center text-lg-start">
                        <h1 class="display-1 lh-1 mb-3">Bank Sampah inayah.</h1>
        ...
        <div class="container px-5">
            <div class="row gx-5 align-items-center justify-content-center justify-content-lg-between">
                <div class="col-12 col-lg-5">
                    ...
                    <p class="small text-muted  mb-5 mb-lg-0">Bank Sampah inayah adalah lembaga yang berkomitmen
                    ...
                    <p class="small text-muted  mb-5 mb-lg-0">
                        ...
                        wujudkan jambi yang lebih hijau!
            ...
            <div class="row gx-5 align-items-center justify-content-center justify-content-lg-between">
                ...
                <div class="col-sm-8 col-md-6">
                    <div class="px-5 px-sm-0">
                        ...
                        <p class="small text-muted  mb-5 mb-lg-0">Bank Sampah in berlokasi di Desa [perintis], Prov jambi. Alamat lengkap kami adalah:
                        </p>
                        <br>
                        <p class="small text-muted  mb-5 mb-lg-0">
                            Jalan [anggrek], No. [Nomor], Desa [anggrek], Prov.jambi
                        </p>
                        <br>
                        <p class="small text-muted  mb-5 mb-lg-0">
    ...
    <footer class="bg-black text-center py-5">
        <div class="container px-5">
            <div class="text-white-50 small">
                <div class="mb-2">&copy; Sistem Informasi Manajemen Bank Sampah inayah 2024. All Rights
                Repost by rzkyyymhmd </a></div>
            </div>
        </div>
    </footer>
    <!-- Bootstrap core JS-->
